...
- Runnable mobile-friendly browser prototype with garage, inventory, canvas arena, HUD, dash controls, level-up cards, settings, audio hooks, rewards, and local save persistence.
...
- `tests/NeonSkySurvivors.Core.Tests/` - .NET core test coverage.
- `tests/web/gameCore.test.mjs` - browser core tests.
