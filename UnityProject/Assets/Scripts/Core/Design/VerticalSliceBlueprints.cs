...
namespace Cosmostar.Core.Design
{
    public static class VerticalSliceBlueprints
    {
        public static VerticalSliceCatalog CreateDefaultCatalog()
        {
            ...
            catalog.Enemies.Add(new EnemyDef { Id = "shard_caster", DisplayName = "Shard Caster", Archetype = EnemyArchetype.ShardCaster, Hull = 40f, Speed = 0.09f, ContactDamage = 10f, FireInterval = 2.4f, TelegraphSeconds = 0.35f, ScoreValue = 1.8f });
            catalog.Enemies.Add(new EnemyDef { Id = "elite_warden", DisplayName = "Elite Warden", Archetype = EnemyArchetype.EliteWarden, Hull = 220f, Speed = 0.1f, ContactDamage = 20f, FireInterval = 1.9f, TelegraphSeconds = 0.45f, ScoreValue = 8f });
            catalog.Enemies.Add(new EnemyDef { Id = "null_sovereign", DisplayName = "Null Sovereign", Archetype = EnemyArchetype.NullSovereign, Hull = 780f, Speed = 0.05f, ContactDamage = 26f, FireInterval = 1.4f, TelegraphSeconds = 0.55f, ScoreValue = 30f, IsBoss = true });
            ...
            catalog.BossPhases.Add(new BossPhaseDef { Id = "boss_phase_1", PhaseIndex = 1, TriggerHealthNormalized = 1f, VolleyInterval = 1.3f, VolleyCount = 3, ProjectileSpeed = 0.18f, TelegraphSeconds = 0.55f, ArenaPulseDamage = 8f });
            catalog.BossPhases.Add(new BossPhaseDef { Id = "boss_phase_2", PhaseIndex = 2, TriggerHealthNormalized = 0.67f, VolleyInterval = 1f, VolleyCount = 4, ProjectileSpeed = 0.22f, TelegraphSeconds = 0.55f, ArenaPulseDamage = 10f });
            catalog.BossPhases.Add(new BossPhaseDef { Id = "boss_phase_3", PhaseIndex = 3, TriggerHealthNormalized = 0.34f, VolleyInterval = 0.75f, VolleyCount = 6, ProjectileSpeed = 0.26f, TelegraphSeconds = 0.55f, ArenaPulseDamage = 12f });
